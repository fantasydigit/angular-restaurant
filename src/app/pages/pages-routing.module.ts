...
import { ActivateAccountPendingComponent } from "./activate-account-pending/activate-account-pending.component";
import { ForgetPasswordPendingComponent } from "./account/forget-password-pending/forget-password-pending.component";
import { ForgetPasswordCompletingComponent } from './account/forget-password-completing/forget-password-completing.component';
import { ForgetPasswordCompleteComponent } from './account/forget-password-complete/forget-password-complete.component';
...
const routes: Routes = [
   ...
   },
   {
      ...
      loadChildren: () =>
         import("./account/register/register.module").then((m) => m.RegisterModule),
   },
   {
      path: "activate-account-pending",
      component: ActivateAccountPendingComponent,
      loadChildren: () =>
         import("./activate-account-pending/activate-account-pending.module").then(
            (m) => m.ActivateAccountPendingModule
         ),
   },
  
   {
      ...
      loadChildren: () =>
         import("./activate-account/activate-account.module").then((m) => m.ActivateAccountModule),
   },
   {
      path: "forget-password",
      component: ForgetPasswordComponent,
      loadChildren: () =>
         import("./account/forget-password/forget-password.module").then(
            (m) => m.ForgetPasswordModule
         ),
   },
   {
      path: "forget-password-pending",
      component: ForgetPasswordPendingComponent,
      loadChildren: () =>
         import("./account/forget-password-pending/forget-password-pending.module").then(
            (m) => m.ForgetPasswordPendingModule
         ),
   },
   {
      path: "forget-password-completing/:code",
      component: ForgetPasswordCompletingComponent,
      loadChildren: () =>
         import("./account/forget-password-completing/forget-password-completing.module").then(
            (m) => m.ForgetPasswordCompletingModule
         ),
   },
   {
      path: "forget-password-complete",
      component: ForgetPasswordCompleteComponent,
      loadChildren: () =>
         import("./account/forget-password-complete/forget-password-complete.module").then(
            (m) => m.ForgetPasswordCompleteModule
         ),
   },
   {
      path: "profile",
   ...
   {
      path: "deleted",
      component: DeletedMerchantComponent,
   }
];
