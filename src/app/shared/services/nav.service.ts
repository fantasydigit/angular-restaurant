...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		...
		{
			path: '/pages/login', title: 'login', type: 'link', active: false 
		}
		// {
	...
	MENUITEMSESSION: Menu[] = [
		...
		{
			path: '/pages/logout', title: 'logout', type: 'link', active: false 
		}
	]

	// Array
	items = new BehaviorSubject<Menu[]>(this.MENUITEMS);
	itemsSession = new BehaviorSubject<Menu[]>(this.MENUITEMSESSION);
	leftMenuItems = new BehaviorSubject<Menu[]>(this.LEFTMENUITEMS);

	filter(){
		this.items.next(this.MENUITEMSESSION);
		this.itemsSession.next(this.MENUITEMSESSION);
	}

	filterLogOut(){
		this.items.next(this.MENUITEMS)
		this.itemsSession.next(this.MENUITEMS);
	}
